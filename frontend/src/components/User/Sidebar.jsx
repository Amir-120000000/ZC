        ...
        <div className="hidden sm:flex flex-col gap-4 w-1/4 px-1">
            ...
            <div className="flex flex-col bg-white rounded-sm shadow">
                ...
                <div className="flex flex-col pb-3 border-b text-sm">
                    <Link to="/account" className={`${activeTab === "profile" ? "bg-green-50 text-primary-green font-medium" : "hover:bg-green-50 hover:text-primary-green"} p-3 pl-14`}>Profile Information</Link>
                    <Link className="p-3 pl-14 hover:bg-green-50 hover:text-primary-green" to="/">Manage Addresses</Link>
                    <Link className="p-3 pl-14 hover:bg-green-50 hover:text-primary-green" to="/">PAN Card Information</Link>
                </div>
                {/* <!-- account settings tab --> */}
                ...
                <div className="flex flex-col pb-3 border-b text-sm">
                    <Link className="p-3 pl-14 hover:bg-green-50 hover:text-primary-green flex justify-between pr-6" to="/">Gift Cards <span className="font-medium text-primary-green">₹0</span></Link>
                    <Link className="p-3 pl-14 hover:bg-green-50 hover:text-primary-green" to="/">Saved UPI</Link>
                    <Link className="p-3 pl-14 hover:bg-green-50 hover:text-primary-green" to="/">Saved Cards</Link>
                </div>
                {/* <!-- payments tab --> */}
                ...
                <div className="flex flex-col pb-3 border-b text-sm">
                    <Link className="p-3 pl-14 hover:bg-green-50 hover:text-primary-green" to="/">My Coupons</Link>
                    <Link className="p-3 pl-14 hover:bg-green-50 hover:text-primary-green" to="/">My Reviews & Ratings</Link>
                    <Link className="p-3 pl-14 hover:bg-green-50 hover:text-primary-green" to="/">All Notifications</Link>
                    <Link to="/wishlist" className={`${activeTab === "wishlist" ? "bg-green-50 text-primary-green font-medium" : "hover:bg-green-50 hover:text-primary-green"} p-3 pl-14`}>My Wishlist</Link>
                </div>
                {/* <!-- my stuff tab --> */}
