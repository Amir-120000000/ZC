                                ...
                                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                                    ...
                                    <div className="flex flex-col gap-5 items-start">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center gap-3" id="personalInputs">
                                            <div className="flex flex-col gap-0.5 w-64 px-3 py-1.5 rounded-sm border inputs cursor-not-allowed bg-gray-100 focus-within:border-primary-green">
                                    ...
                                    <div className="flex flex-col gap-5 items-start">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="flex flex-col gap-0.5 sm:w-64 px-3 py-1.5 rounded-sm border bg-gray-100 cursor-not-allowed focus-within:border-primary-green">
